        ...
        border-radius: 5px;;
                            ...
                            <form class="form-horizontal profile-info " enctype="multipart/form-data"  method="post" action="{{route('PostProfile',Auth::user()->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number"  class="form-control " name="phone" value="{{old('phone',isset($profile) ? $profile['phone']:null)}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-3 control-label">Địa chỉ</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control " placeholder="Vui lòng nhập đúng địa chỉ nhà bạn ." name="address" value="{{old('address',isset($profile) ? $profile['address']:null)}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="country" id="province_id" class="form-control " required >
                                            <option value="">Vui Lòng Chọn Tỉnh Thành</option>
                                            @foreach($city as $country)
                                                <option  value="{{ $country['id']}}"  <?php if( $country['id']==$profile['city_id'] ) echo 'selected';?> label="{{ $country['name'] }}"  >
                                                    {{ $country['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
