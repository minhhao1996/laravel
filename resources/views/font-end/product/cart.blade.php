                        ...
                        <div class="cart-content" id="cart-content"
                            ...
                            <div class="cart-block-info">
                                <div class="cart-info table-responsive">
                                    <table class="table product-list">
                                        ...
                                        <tr  class="{{$con['id']}}">
                                            ...
                                            <td class="amount iteml{{$con['id']}} ">
                                                {{number_format($con['price']*$con['quantity'])}}đ
                                            </td>
                                            <td class="">
                                                <a onclick="onChangeRM(id)"  id="{{$con['id']}}" >
                                                    ...
                                                    function onChangeSL(id){
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                    ...
                                                                    let price= data['price'] +'đ';
                                                                    let total=data['total'] +'đ';
                                ...
                                <div class="clearfix text-right">
                                    ...
                                    <span class="pay-price ng-binding" id="totalamount">
